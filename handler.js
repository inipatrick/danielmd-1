                       ...
                       let pp = 'https://telegra.ph/file/64691c22ee84bde72b031.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Yah,si Beban Masuk Grup').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
                                ...
                                this.sendButtonImg(id, pp, text, "©Anggan Official", "Okee", "wkwk", null)
                                }
                    }
                }
                break
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*Perintah ini Khusus Anggan Offcial*',
        owner: '*Perintah ini Khusus Anggan Official*',
...
let msgg = {
unreg: '*❒ DANIEL MD ❒*\n\nUntuk Menggunakan Bot Silahkan\nRegister Terlebih Dahulu Ya Sans\nUntuk Menggunakan Fitur Bot Ya Tod\n\n*Klik Tombol Di Bawah Tod Untuk Login*'
}[type]
if (msgg) return conn.sendButtonImg(m.chat, fla + 'NOT VERIFY', msgg, wm, '🌸 REGISTER', '.daftar User Gratisan.20', m) 
}
