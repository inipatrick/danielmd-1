...
//━━━━━━━━[ DATABASE USER ]━━━━━━━━//
  try {
    ...
    let registered = global.db.data.users[m.sender].registered
...
const template = generateWAMessageFromContent(m.key.remoteJid, proto.Message.fromObject({
        listMessage: {
            ...
            listType: 1,
            footerText: "⬣━〔Powered By ©Anggan Official〕━⬣\n       ▌│█║▌║▌║║▌║▌║█│▌",
            mtype: 'listMessage',
            sections: [
              {
                "rows": [{
                  ...
                  "title": "🥈CONTIBUTOR",
                  "description": "Menampilkan Siapa Yang Membantu Owner",
                  "rowId": `${_p}tqto`
                }],
                "title": "INFORMASI BOT"
              }, {
          ...
          hydratedTemplate: {
            ...
            urlButton: {
             ...
             quickReplyButton: {
               ...
               {
             quickReplyButton: {
               displayText: 'RULES DANIELBOTZ-MD',
               id: '.rules',
             }
